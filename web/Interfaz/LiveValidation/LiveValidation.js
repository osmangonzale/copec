...
var Validate = {
    ...
    Char: function(value, paramsObj){
        ...
        Validate.Format(value, {
            failureMessage: message,
            //            pattern: /^[a-zA-Z]+([ ]+[a-zA-Z]{0,})$/i
            //            pattern: /^[a-zA-ZÉÍÓÚÑ]+[ ]*[a-zA-Záéíóúñ]*$/i
            pattern: /^[a-zA-Z\D1F1]+[ ]*[a-zA-Z\D1F1]*$/i
        } );
        return true;
    },
    CharLength: function(value, paramsObj){
        var paramsObj = paramsObj || {};
        var message = paramsObj.failureMessage || "";
        Validate.Format(value, {
            failureMessage: message,

            pattern: /^[a-zA-Z]{1,3}$/i
        } );
        return true;
    },
    Register: function(value, paramsObj){
        var paramsObj = paramsObj || {};
        var message = paramsObj.failureMessage || "";
        Validate.Format(value, {
            failureMessage: message,
            pattern: /^R-[A-Z]{2,3}-[0-9]{3,3}$/i
        } );
        return true;
    },
    FunctionManual: function(value, paramsObj){
        var paramsObj = paramsObj || {};
        var message = paramsObj.failureMessage || "";
        Validate.Format(value, {
            failureMessage: message,
            pattern: /^MF-[A-Z]{2,3}-[0-9]{3,3}$/i
        } );
        return true;
    },
    FunctionNumeric: function(value, paramsObj){
        var paramsObj = paramsObj || {};
        var message = paramsObj.failureMessage || "";
        Validate.Format(value, {
            failureMessage: message,
            pattern: /^Mn-[0-9]{0,4}$/i
        } );
        return true;
    },
    ...
    Confirmation: function(value, paramsObj){
        ...
        var paramsObj = paramsObj || {};
        var message = paramsObj.failureMessage || "El campo no coincide!";
